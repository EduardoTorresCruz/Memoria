class BabyRoom extends GameScene {
    ...
    preload() {
        ...
        this.load.image('RoomOn', 'Babyroom/babyRoomOn.png')
        this.load.image('RoomOff', 'Babyroom/babyRoomOFF.png')
    ...
    onEnter() {
        this.roomOn = this.physics.add.sprite(game.config.width/2-208, game.config.height/2, 'RoomOn').setScale(0.7).setImmovable(true);
